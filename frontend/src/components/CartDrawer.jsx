    ...
    >
      ...
      <div className="fixed inset-y-0 right-0 max-w-full flex">
        ...
        <div
          ...
          className="w-screen max-w-md sm:w-[420px] bg-[#06110f] border-l border-[#19352d] shadow-2xl flex flex-col justify-between transform transition-transform duration-300 ease-in-out"
        >
          {/* Drawer Header */}
          <div className="p-5 sm:p-6 border-b border-[#19352d] flex items-center justify-between bg-[#081713]">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-xl bg-[#102720] border border-[#19352d] text-[#35d6b0]">
                <ShoppingBag className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-lg font-extrabold text-[#f5f7f4] tracking-tight">Your Cart</h3>
            ...
            <button
              ...
              className="p-2 rounded-xl text-[#71847c] hover:text-[#f5f7f4] hover:bg-[#102720] transition-colors focus:outline-none focus:ring-2 focus:ring-[#35d6b0]"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
            ...
            {loading ? (
              ...
              <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-4 my-auto">
                ...
                <div className="space-y-1.5">
                  <h4 className="text-lg font-bold text-[#f5f7f4]">Your cart is empty</h4>
                ...
                <button
                  ...
                  className="btn-teal text-xs py-2.5 px-5 mt-3"
                >
          ...
          {!loading && !cartError && cart.items && cart.items.length > 0 && (
            <div className="p-5 sm:p-6 border-t border-[#19352d] bg-[#081713] space-y-4">
              <div className="flex justify-between items-center text-base font-extrabold text-[#f5f7f4] pt-1">
                <span className="text-sm font-bold text-[#f5f7f4]">Total</span>
                <span className="text-xl font-extrabold text-[#35d6b0]">
                  ₹{formattedTotal}
                </span>
              </div>
              ...
              <button
                type="button"
                className="btn-teal w-full py-3.5 text-sm font-bold shadow-lg shadow-[#35d6b0]/20"
              >
