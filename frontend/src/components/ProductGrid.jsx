...
const ProductGrid = ({
  ...
  if (error) {
    return (
      <div className="surface-card p-6 sm:p-12 text-center max-w-md mx-auto my-8 space-y-4 border-[#ff7272]/30 shadow-lg">
        ...
        <div className="space-y-1.5">
          <h3 className="text-lg sm:text-xl font-bold text-[#f5f7f4]">Unable to load products</h3>
          <p className="text-xs sm:text-sm text-[#a2b3ac]">
  ...
  if (!products || products.length === 0) {
    return (
      <div className="surface-card p-6 sm:p-12 text-center max-w-md mx-auto my-8 space-y-4 shadow-lg">
        ...
        <div className="space-y-1.5">
          <h3 className="text-lg sm:text-xl font-bold text-[#f5f7f4]">No products found</h3>
          <p className="text-xs sm:text-sm text-[#a2b3ac]">
