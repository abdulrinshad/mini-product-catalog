  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 items-stretch">
      {Array.from({ length: count }).map((_, index) => (
        <div
          key={index}
          className="surface-card p-5 space-y-4 animate-pulse border border-[#19352d]/60 flex flex-col justify-between"
        >
          ...
          <div className="h-48 sm:h-52 w-full bg-[#081713]/80 border border-[#19352d]/40 rounded-xl flex items-center justify-center">
          ...
          <div className="pt-3 border-t border-[#19352d]/60 flex items-center justify-between">
            ...
            <div className="h-9 w-28 bg-[#102720] rounded-xl" />
          </div>
        </div>
      ))}
    </div>
