...
import { Cpu, Mail, Lock, Eye, EyeOff, Loader2, AlertCircle, ArrowLeft, CheckCircle2 } from 'lucide-react';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#06110f] text-[#f5f7f4] font-sans flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-[300px] h-[300px] bg-[#dfff72]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-[#091a15]/90 border border-[#19352d] backdrop-blur-xl rounded-2xl p-6 sm:p-8 shadow-2xl z-10">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs sm:text-sm text-[#a2b3ac] mt-1.5">
            Sign in to your TECHORA account to continue
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          {/* Email Field */}
          <div>
            <label className="block text-xs font-semibold text-[#a2b3ac] uppercase tracking-wider mb-2">
              Email Address
            </label>
            <div className="relative">
              ...
              <input
                ...
                required
                autoComplete="email"
                className="custom-input w-full pl-10 pr-4 py-3 text-sm rounded-xl"
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-xs font-semibold text-[#a2b3ac] uppercase tracking-wider">
                Password
              </label>
            </div>
            <div className="relative">
              ...
              <input
                ...
                className="custom-input w-full pl-10 pr-11 py-3 text-sm rounded-xl"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-teal w-full py-3.5 text-sm font-bold rounded-xl shadow-lg flex items-center justify-center gap-2 mt-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
